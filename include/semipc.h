...
//----------------------------------------------------------------------
    ...
    */
    extern "C" IPC_handle IPC_createSemaphore(const IPC_str *name, int value);
    ...
    \param value - начальное значение семафора
    */
    extern "C" IPC_handle IPC_createSemaphoreEx(const IPC_str *name, int value, ... );
    ...
    */
    extern "C" int IPC_lockSemaphore(const IPC_handle handle, int timeout);

    //! Функция освобождает занятый семафор
    /*!
    \param handle - дескриптор семафора
    */
    extern "C" int IPC_unlockSemaphore(const IPC_handle handle);

    //! Функция удаляет именованный объект семафора
    /*!
    \param handle - дескриптор семафора
    */
    extern "C" int IPC_deleteSemaphore(IPC_handle handle);
